...
import 'orders_list_view_model.dart';

class RetailersOrderListView extends StatelessWidget {
  const RetailersOrderListView({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<RetailersOrderListViewModel>.reactive(
        viewModelBuilder: () => RetailersOrderListViewModel(),
