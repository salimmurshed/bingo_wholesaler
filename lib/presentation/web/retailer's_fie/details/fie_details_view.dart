...
import 'fie_details_view_model.dart';

class FieDetailsView extends StatelessWidget {
  const FieDetailsView({super.key, this.id});
  final String? id;
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<FieDetailsViewModel>.reactive(
        viewModelBuilder: () => FieDetailsViewModel(),
        onViewModelReady: (FieDetailsViewModel model) {
          model.getData(id);
        },
