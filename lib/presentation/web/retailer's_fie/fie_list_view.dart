...
import 'fie_list_view_model.dart';

class FieListView extends StatelessWidget {
  const FieListView({super.key, this.page});

  final String? page;

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<FieListViewModel>.reactive(
        viewModelBuilder: () => FieListViewModel(),
        onViewModelReady: (FieListViewModel model) {
          model.getFieList(page);
        },
