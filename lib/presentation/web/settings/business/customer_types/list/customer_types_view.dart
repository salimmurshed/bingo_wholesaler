...
import 'customer_types_view_model.dart';

class CustomerTypesView extends StatelessWidget {
  const CustomerTypesView({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<CustomerTypesViewModel>.reactive(
        viewModelBuilder: () => CustomerTypesViewModel(),
