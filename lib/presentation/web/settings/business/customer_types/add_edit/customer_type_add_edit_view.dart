...
import 'customer_type_add_edit_view_model.dart';

class AddEditCustomerTypeView extends StatelessWidget {
  const AddEditCustomerTypeView({super.key, this.data});
  final String? data;
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<AddEditCustomerTypeViewModel>.reactive(
        viewModelBuilder: () => AddEditCustomerTypeViewModel(),
        onViewModelReady: (AddEditCustomerTypeViewModel model) {
          model.prefill(data);
        },
