...
import 'flat_icon1.dart';
import 'flat_icon_new_icons.dart';
...
class ParagraphButtons extends Toolbar {
  ...
  List<Icon> getIcons1() {
    ...
    if (alignLeft)
      icons.add(Icon(
        FlatIcon1.align_left,
        color: colorIcon,
        size: sizeIcon,
      ));
    if (alignCenter)
      icons.add(Icon(
        FlatIcon1.align_center,
        color: colorIcon,
        size: sizeIcon,
      ));
    if (alignRight)
      icons.add(Icon(
        FlatIcon1.align_right,
        color: colorIcon,
        size: sizeIcon,
      ));
    if (alignJustify)
      icons.add(Icon(
        FlatIcon1.justification,
        color: colorIcon,
        size: 18,
      ));
    return icons;
