...
class FieDetailsView extends StatelessWidget {
  const FieDetailsView(this.data, {super.key});

  final RetailerAssociationFieListData data;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            AppBarText(AppLocalizations.of(context)!.fieDetails.toUpperCase()),
      ),
      body: SizedBox(
        height: 100.0.hp,
        child: Padding(
                ...
                ShadowCard(
                  child: Column(
                    ...
                    children: [
                      ...
                      15.0.giveHeight,
                      Utils.getNiceText(
                          "${AppLocalizations.of(context)!.phoneNumber}:${data.phoneNumber!.emptyCheck()}",
                          nxtln: true),
                    ],
                  ),
                ),
